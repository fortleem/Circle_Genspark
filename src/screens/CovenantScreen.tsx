// §1 — Executive Vision & Core Commitments (full sub-section coverage 1.1 → 1.9)
...
export function CovenantScreen() {
  ...
  return (
    ...
    >
      {/* 1.2 Core Promises */}
      <SectionHeader title="§1.2 The Circle Covenant" hint="Non-negotiable commitments" />
      ...
      {/* 1.3 Problem → Solution Matrix */}
      <SectionHeader title="§1.3 Problem → Solution Matrix" hint="Why Circle exists" />
      ...
      <SectionHeader title="§1.4 Zero-Cost Architecture" hint="Seven principles" />
      ...
      {/* 1.5 Target Audience */}
      <SectionHeader title="§1.5 Who is Circle for?" hint="Six core audiences" />
      ...
      <SectionHeader title="§1.6 Year-1 Goals (Egypt launch)" hint="Quantitative targets" />
      <GlassCard className="overflow-x-auto mb-12">
        <table className="w-full text-sm">
          <thead>
            <tr className="text-[10px] uppercase tracking-wider text-muted-foreground">
      ...
      <SectionHeader title="§1.7 What Circle replaces" hint="One app, eleven dethroned" />
      ...
      <SectionHeader title="§1.8 Long-Term Vision (10 Years)" />
      ...
      {/* 1.9 Summary */}
      <SectionHeader title="§1.9 Five Radicals" hint="The summary of Part 1" />
      ...
      <div className="text-center pt-4">
        ...
        <div className="flex flex-wrap gap-2 justify-center">
          <Link to="/identity"     className="px-4 py-2 rounded-full glass border border-border/40 text-xs">§2 Brand</Link>
          <Link to="/architecture" className="px-4 py-2 rounded-full glass border border-border/40 text-xs">§3 Architecture</Link>
          <Link to="/dre"          className="px-4 py-2 rounded-full glass border border-border/40 text-xs">§4 DRE</Link>
          <Link to="/vision"       className="px-4 py-2 rounded-full bg-secondary text-secondary-foreground text-xs">§1 Long-term Vision →</Link>
        </div>
      </div>
    </PageShell>
  );
