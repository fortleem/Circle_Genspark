...
export interface CircleGroup { id: number; slug: string; name: string; description: string; mode: string; member_count: number; ipfs_cid?: string }
export interface Channel  { id: number; slug: string; name: string; channel_type: string; subscriber_count: number; verified_at?: string; description?: string; logo_url?: string; category?: string; country?: string }
export interface Job      { id: number; title: string; company: string; location: string; remote: number; created_at: string; posted_by_name?: string; description?: string; salary_min?: number; salary_max?: number; salary_currency?: string; tags?: string }
...
export interface Mail     { id: number; user_id: number; from_addr: string; to_addr: string; subject: string; preview: string; folder: string; is_read: number; created_at: string; ai_summary?: string }
